...
window.GROUPS = [
  ...
  {slug:'direwolf',name:'DireWolf',id:'24',status:'Active',model:'Closed Crew',active:'2025 to present',color:'#7f8c8d',img:'photos/direwolf.svg',note:'Closed crew, no established lineage. Golang encryptor, Curve25519 plus ChaCha20. 100 victims across 32 countries; burst-and-dormancy tempo.',related:[]},
  ...
  {slug:'medusa',name:'Medusa',id:'25',status:'Inactive',model:'RaaS',active:'2021 to 2026',color:'#16a085',img:'photos/medusa.svg',note:'Vetted RaaS, 500+ confirmed victims. Rapid n-day exploitation of file-transfer and RMM platforms; vulnerable-driver EDR killers. Leak site dormant since April 2026; zero law enforcement actions in five years.',related:[]},
  ...
  {slug:'scatteredspider',name:'Scattered Spider',id:'16',status:'Active',model:'Data Extortion',active:'2022 to present',color:'#e67e22',img:'photos/scatteredspider.svg',note:'English-speaking social-engineering collective (The Com). Deploys ALPHV, RansomHub, Qilin, DragonForce.',related:['dragonforce','qilin','alphv','shinyhunters']},
  {slug:'shinyhunters',name:'ShinyHunters',id:'26',status:'Active',model:'Data Extortion',active:'2020 to present',color:'#6c5ce7',img:'photos/shinyhunters.svg',note:'French-origin data theft and extortion brand; BreachForums administrator; SaaS and identity intrusions; SLSH alliance with Scattered Spider.',related:['scatteredspider','clop']},
